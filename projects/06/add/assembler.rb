class Parser
	...
	def jump
		if @curren_command_type == "C_COMMAND" && @current_command.include?(";")
			puts "jump: #{@current_command.split(";")[0]}"
			return @current_command.split(";")[0]
		end
		return "NULL"
	end
